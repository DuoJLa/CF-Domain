...
**每天自动推送Cloudflare优选域名TOP5到您的Telegram Bot**
...
- ⏰ **定时推送** - 每天按时推送
- 📊 **详细数据** - 包含排行、延迟、丢包率、三网表现
- 🚀 **高效稳定** - 轻量级Python脚本，运行快速
- 💰 **完全免费** - 零成本部署和运行
...
2. 发送 `/newbot` 创建新机器人
3. 按提示设置名称和用户名
4. **保存返回的Token** (格式: `123456:ABCdefGHI...`)
...
| Name | Value | 说明 |
|------|-------|------|
| `TELEGRAM_BOT_TOKEN` | `123456:ABCdef...` | 你的Bot Token |
| `TELEGRAM_CHAT_ID` | `123456789` 或 `-100123456` | 你的Chat ID |
...
现在每天早上8:00会自动推送数据到你的Telegram Bot🎉
